  ...
  <tr>
    <td class="back" "valign="top" nowrap="nowrap" background="images/bkgrd_image.jpg"><br />
      <table width="86%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<%end if%>
        <tr>
          <td valign="top"><p><span class="main">Employee Relations Specialist<br />
            </span><br />
            <span class="sub">Description of the Role</span><br />
            <br />
            The Employee Relations Specialist is responsible for providing human resources support for Employee Relations including the areas of administration, complaint research, resolution and response, developing reports and other various employee issues.  S/he may provide employee and management counseling and assist the ER Manager with researching different issues. <br />
            <br />
            <span class="sub"><a name="prep" id="prep"></a>Preparation for the Role</span><br />
            <br />
            The following experience and recommended qualifications have been cited as useful for preparation as an Employee Relations Specialist. Those seeking this position should have proven experience and/or qualifications in one or more of the following areas:
            </p>
            <%if strActionPlan <> 0 Then%>
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <span class="style1">o</span>
	  ...
	  <% End If %>		
            <p><span class="sub"><a name="key" id="key"></a>Key Accountabilities</span><br />
              ...
              &nbsp;&nbsp;&nbsp;&#9642; Support the ER Manager in the employee retention system, ensuring fair treatment and a positive work<br />
  &nbsp;&nbsp;&nbsp;&nbsp;            environment<br />
            ...
            <p>This role requires the Employee Relations Specialist to interact with a variety of people and departments, which may include:<br />
              <br />
              &nbsp;&nbsp;&nbsp;&#9642; Internal Staff to help them in dealing with employee issues and decide action steps to take<br />
              &nbsp;&nbsp;&nbsp;&#9642; Employee Relations Manager to receive direction, coaching and feedback <br />
              ...
              <br />
              Typical challenges associated with the Employee Relations Specialist may include:<br />
  ...
  &nbsp;&nbsp;&nbsp;&#9642; Information Seeking          </p>
            ...
            <p><span class="sub"><a name="devop" id="devop"></a>Developmental Opportunities</span><br />
              ...
              <a href="http://www.elearning.shrm.org/miderspecialist_development.aspx" target="_blank">Developmental Opportunities</a>
