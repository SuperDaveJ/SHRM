...
<title>Diversity Specialist</title>
...
<table width="770" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <span class="style1">&thorn;</span>
  <% End If %>
                  5-7 years of work experience in the area of diversity <br />
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <span class="style1">o</span> Second language </td>
	  ...
	  <% End If %>		
            <p><span class="sub"><a name="key" id="key"></a>Key Accountabilities</span><br />
              <br />
              &nbsp;&nbsp;&nbsp;&#9642; Assist with the development of policies and programs to attract, retain and promote a diverse workforce for the<br />
  &nbsp;            &nbsp;&nbsp;&nbsp;organization<br />
              &nbsp;&nbsp;&nbsp;&#9642; Determine the appropriateness of introducing diversity initiatives and consider the unique needs of the<br />
  &nbsp;            &nbsp;&nbsp;&nbsp;organization<br />
              &nbsp;&nbsp;&nbsp;&#9642; Train and educate employees and mangers on how to recognize, accommodate and appreciate individual<br />
  &nbsp;&nbsp;&nbsp;&nbsp;            differences<br />
              ...
              &nbsp;&nbsp;&nbsp;&#9642; Determine the appropriateness of introducing diversity initiatives and consider the unique needs of the<br />
  &nbsp;&nbsp;&nbsp;&nbsp;            organization<br />
              &nbsp;&nbsp;&nbsp;&#9642; Acts as a liaison within the company to ensure coordination in the implementation of the diversity strategy<br />
  &nbsp;&nbsp;&nbsp;&nbsp;            throughout the business <br />
              ...
              <br />
              This role requires the Organizational Development Specialist and Trainer to interact with a variety of people and departments, which may include:<br />
              <br />
            ...
            <p><span class="sub"><a name="challenges" id="challenges"></a>Challenges in the Role</span><br />
              <br />
              Typical challenges associated with the Diversity Specialist may include:<br />
              <br />
              &nbsp;&nbsp;&nbsp;&#9642; Dealing with and overcoming employee resistance to participating in diversity initiatives<br />
              &nbsp;&nbsp;&nbsp;&#9642; Handling employees that are discriminatory <br />
            &nbsp;&nbsp;&nbsp;&#9642; Continually identifying barriers to the success of diversity </p>
            <p><span class="sub"><a name="keycomp" id="keycomp"></a>Key Competencies</span><br />
              <br />
              The following competencies are considered necessary for success in the role of Diversity Specialist<br />
              <br />
  ...
  &nbsp;&nbsp;&nbsp;&#9642; Information Seeking</p>
            ...
            <p><span class="sub"><a name="devop" id="devop"></a>Developmental Opportunities</span><br />
              ...
              <a href="http://www.elearning.shrm.org/largediversityspecialist_development.aspx" target="_blank">Developmental Opportunities</a>
