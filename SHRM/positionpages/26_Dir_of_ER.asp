...
<title>Director of Employee Relations</title>
...
<table width="770" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<%End If%>
        <tr>
          <td valign="top"><p><span class="main">Director of Employee Relations <br />
            </span><br />
            <span class="sub">Description of the Role</span><br />
            <br />
            The Director of Employee Relations is responsible for coordinating and directing the Employee Relations programs and functions. S/he has primary responsibility for managing employee relations.  S/he manages employee relations activities according to established guidelines and sound administrative practices.  In addition s/he handles resolving employee relations regarding HR policies, conflict resolution, performance problems and terminations.  Other responsibilities may include guidance with layoffs, investigations regarding discrimination and harassment, creating training programs and reviewing background checks. <br />
            <br />
            <span class="sub"><a name="prep" id="prep"></a>Preparation for the Role</span><br />
            <br />
            The following experience and recommended qualifications have been cited as useful for preparation as a Director of Employee Relations. Those seeking this position should have proven experience and/or qualifications in one or more of the following areas:</p>
           <%if strActionPlan <> 0 Then%>
			<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><p><span class="sub">Required Experience</span> <br />
                  ...
                  <% End If %>
                  Bachelor&rsquo;s Degree and Master&rsquo;s Degree in  Counseling, Psychology or HR related field<br />
  <%IF rstSimple.Fields("UserHRExperience").Value < 10 Then%>
  <span class="style1">o</span>
  <%Else%>
  <span class="style1">&thorn;</span>
  <% End If %>
                  10-12 years of work experience in human resources management<br />
  <span class="style1">o</span> At least 5 years of experience in employee relations<br />
  <span class="style1">o</span> Minimum of 5 years of supervisory experience<br />
  ...
  <span class="style1">o</span> Strong knowledge of employment laws and practices<br />
  <br />
  ...
  <% End If %>
                  SPHR <br />
  <span class="style1">o</span> Certificate in Mediation</td>
              </tr>
            </table>
<%Else%>
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <span class="style1">o</span> Certificate in Mediation</td>
	 ...
	 <% End If %>		
            <p><span class="sub"><a name="key" id="key"></a>Key Accountabilities</span><br />
              ...
              <br />
              This role requires the Director of Employee Relations to interact with a variety of people and departments, which may include:<br />
              <br />
              ...
              &nbsp;&nbsp;&nbsp;&#9642; VP of HR to take direction and inform of employee relations trends<br />
              &nbsp;&nbsp;&nbsp;&#9642; Director of Training and OD to collaborate on addressing systemic employee relations issues<br />
              <br />
              <span class="sub"><a name="challenges" id="challenges"></a>Challenges in the Role</span><br />
              <br />
              Typical challenges associated with the Director of Employee Relations may include:<br />
              <br />
              ...
              &nbsp;&nbsp;&nbsp;&#9642; Monitoring climate issues in multiple organizational locations<br />
              <br />
              <span class="sub"><a name="keycomp" id="keycomp"></a>Key Competencies</span><br />
              <br />
              The following competencies are considered necessary for success in the role of Director of Employee Relations<br /> 
              <br />
  ...
  <br />
            ...
            <p><span class="sub"><a name="devop" id="devop"></a>Developmental Opportunities</span><br />
              ...
              <a href="http://www.elearning.shrm.org/largeer_development.aspx" target="_blank">Developmental Opportunities</a>
