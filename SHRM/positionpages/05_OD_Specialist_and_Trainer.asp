...
<title>Organizational Development Specialist and Trainer</title>
...
<table width="770" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="back" "valign="top" nowrap="nowrap" background="images/bkgrd_image.jpg"><br />
	  <table width="86%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	    ...
	    <%end if%>		
	    <tr>
	      <td valign="top"><p><span class="main">Organizational Development Specialist and Trainer</span><br />
	        <br />
	        <span class="sub">Description of the Role</span><br />
	        <br />
	        The Organizational Development Specialist and Trainer is responsible for identifying and designing training strategies, programs and interventions to meet the strategic goals and objectives of the organization.  S/he assesses requests for training and development opportunities, conducts needs assessments for training programs and facilitates corporate culture change strategies.  It is also his/her responsibility to serve as an internal management and educational coach/consultant.  He/she provides assessment and referral, coaching and feedback to employees and managers in various OD areas.  S/he will facilitate training and conduct measurement and evaluation of training programs.  S/he must be familiar with instructional technologies in order to implement online training courses. </p>
            <p><span class="sub"><a name="prep" id="prep"></a>Preparation for the Role</span><br />
              <br />
            The following experience and recommended qualifications have been cited as useful for preparation as an Organizational Development Specialist and Trainer. Those seeking this position should have proven experience and/or qualifications in one or more of the following areas:          </p>
         <%if strActionPlan <> 0 Then%>
  ...
  <span class="style1">o</span> Experience in training, organizational development, leadership development and change<br />
  &nbsp;&nbsp;&nbsp; management <br />
  ...
  <br />
  <%IF rstSimple.Fields("UserMaxEducation").Value > 4 Then%>
  <span class="style1">o</span>
  <%Else%>
  <span class="style1">&thorn;</span>
  <% End If %>
	              Master&rsquo;s Degree in Adult Education, Organizational Development, Organizational Effectiveness or <br />
  &nbsp;&nbsp;&nbsp; I/O Psychology<br />
  <%IF rstSimple.Fields("UserCert_PHR").Value > "yes" OR rstSimple.Fields("UserCert_SPHR").Value > "yes" Then%>
	              'Tests for Bachelor as Minimum<span class="style1">o</span>
  <%Else%>
  <span class="style1">&thorn;</span>
  <% End If %>
                PHR/SPHR </td>
...
<% End If %>			 
	        <p><span class="sub"><a name="key" id="key"></a>Key Accountabilities</span><br />
	          ...
	          &nbsp;&nbsp;&nbsp;&#9642; Facilitate training and organizational development courses and new systems <br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;            management, performance improvement, leadership development and team effectiveness <br />
	          ...
	          &nbsp;&nbsp;&nbsp;&#9642; Act as internal consultant to assist staff at all levels with team building, resume writing, leadership &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;development, facilitation, and holding effective meetings <br />
	          &nbsp;&nbsp;&nbsp;&#9642; Oversee internal consulting on needs assessment, work group performance improvement and change<br />
  &nbsp;            &nbsp;&nbsp;&nbsp;management. <br />
	          &nbsp;&nbsp;&nbsp;&#9642; Formulate teaching outline and determine instructional methods such as individual training, group instruction,<br />
  &nbsp;&nbsp;&nbsp;&nbsp;            lectures, demonstrations, conferences, meetings and workshops<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;            to meet the needs of adult learners<br />
	          &nbsp;&nbsp;&nbsp;&#9642; Design training in adherence to instruction design principles <br />
	          <br />
            <span class="sub"><a name="primary" id="primary"></a>Primary Interfaces</span></p>
            <p>This role requires the Organizational Development Specialist and Trainer to interact with a variety of people and departments, which may include:<br />
              <br />
              &nbsp;&nbsp;&nbsp;&#9642; Internal Staff to administer training <br />
              &nbsp;&nbsp;&nbsp;&#9642; Managers for needs assessment and to gain support for training<br />
              &nbsp;&nbsp;&nbsp;&#9642; Manager, Training and Organizational Development  for direction, feedback and guidance <br />
              &nbsp;&nbsp;&nbsp;&#9642; Third Party Vendor to seek outside help with special training<br />
              &nbsp;&nbsp;&nbsp;&#9642; EAP for coordination of services and employee referrals <br />
              &nbsp;&nbsp;&nbsp;&#9642; ER Specialist to address systemic and OD needs<br />
              <br />
              <span class="sub"><a name="challenges" id="challenges"></a>Challenges in the Role</span><br />
              <br />
              Typical challenges associated with the Organizational Development Specialist and Trainer may include:<br />
              <br />
              ...
              <br />
              The following competencies are considered necessary for success in the role of Organizational Development Specialist and Trainer<br />
              <br />
  ...
  &nbsp;&nbsp;&nbsp;&#9642; Teamwork and Collaboration          </p>
            ...
            <p><span class="sub"><a name="devop" id="devop"></a>Developmental Opportunities</span><br />
              ...
              <a href="http://www.elearning.shrm.org/midod_development.aspx" target="_blank">Developmental Opportunities</a>
